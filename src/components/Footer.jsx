...
export default function Footer() {
  return (
    <footer className="bg-black text-white md:pt-14 md:pb-12 font-PlusJakartarSans text-sm">
      <div className="flex flex-col content-center font-extralight md:font-normal md:flex-row md:justify-around pb-8 pl-2">
        <section className="text-center md:text-left">
          <ul>
            <li className="pb-2 md:pb-6 text-xl md:text-2xl">Support</li>
            <li>Grafikr A/S</li>
        ...
        <section className="text-center md:pr-20 md:text-left">
          <ul className="leading-6">
            <li className="pb-2 text-xl md:pb-6 md:text-2xl">Information</li>
        ...
        <section className="text-center pb-8 md:text-left">
          <ul className="leading-6">
            <li className="pb-2 text-xl md:pb-6 md:text-2xl">Udvalgte Cases</li>
            <li>
